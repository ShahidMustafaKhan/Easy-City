...
import '../view/customization/videos/videos_screen.dart';

class RouteHelper {
  static const String initial = '/';
  static const String bookingSection = '/bookingSection';
  static const String filter = '/filter';
  static const String chat = '/chat';
  static const String service = '/service';
  static const String messageSocial = '/messageSocial';
  static const String comments = '/comments';
  static const String chatSocial = '/chatSocial';
  ...
  static bool isFromService = false;
  static int serviceId = 0;

  static String getInitialRoute() => '$initial';
  static String getBookingSectionRoute() => '$bookingSection';
  static String getFilterScreenRoute({bool isFromServiceProvider}) {
    isFromService = isFromServiceProvider;
    return '$filter';
  }

  static String getBookingChatRoute() => '$chat';
  static String getServiceRoute(int serviceID) {
    serviceId = serviceID;
    return '$service';
  }

  static String geSocialMessageRoute(String id, String name, String url) {
    // print(id);
    // print(name);
    // print(url);
    id1 = id;
  ...
  static String geCommentsRoute(String postID) {
    // print(id);
    // print(name);
    // print(url);
    postId = postID;
  ...
  static String getSocialChatRoute() => '$chatSocial';
  static String getFilterViewRoute() => '$filterView';
  ...
  static String getBlogsRoute(String page) => '$blogs?page=$page';
  static String getVideosRoute(String page) => '$videos?page=$page';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: bookingSection,
        page: () => getRoute(DashboardScreen(pageIndex: 2))),
    GetPage(
        name: splash,
        page: () {
    ...
    GetPage(name: blogs, page: () => BlogScreen(isAllBlogs: true)),
    GetPage(name: videos, page: () => VideoScreen(isAllVideos: true)),
  ...
  static getRoute(Widget navigateTo) {
    ...
    return Get.find<LocationController>().getUserAddress() == null
